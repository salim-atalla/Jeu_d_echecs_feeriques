...
var TestQueenMoves = /** @class */ (function () {
    function TestQueenMoves() {
    }
    TestQueenMoves.prototype.beforeEach = function () {
        // TODO:
        // Initialize an empty chessboard
        chessboard = chessboard_1.createEmptyChessboard();
        // Place a white Queen on E4
        chessboard_1.putPiece(chessboard, positionE4, piece_1.whiteQueen);
    };
    TestQueenMoves.prototype.testCanMoveDiagonally = function () {
        // TODO:
        // Check the following moves are possible: 
        // moveE4_A8, moveE4_B1, moveE4_H7, moveE4_H1 
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionA8))).toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionB1))).toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionH7))).toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionH1))).toBeTruthy();
    };
    TestQueenMoves.prototype.testCanMoveHorizontally = function () {
        // TODO:
        // Check the following moves are possible: moveE4_H4, moveE4_A4
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionH4))).toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionA4))).toBeTruthy();
    };
    TestQueenMoves.prototype.testCanMoveVertically = function () {
        // TODO:
        // Check the following moves are possible: moveE4_E1, moveE4_E8
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionE1))).toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionE8))).toBeTruthy();
    };
    TestQueenMoves.prototype.testForbiddenMoves = function () {
        // TODO:
        // Check the following moves are impossible: moveE4_C7, moveE4_B2
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionC7))).not.toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionB2))).not.toBeTruthy();
    };
    TestQueenMoves.prototype.testCannotLeap = function () {
        // TODO:
        ...
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionA8))).not.toBeTruthy();
        alsatian_1.Expect(isPossible.queenMove(chessboard, movements_1.move(positionE4, positionH4))).not.toBeTruthy();
    };
    TestQueenMoves.prototype.testCannotCaptureSameColor = function () {
        // TODO:
    ...
    TestQueenMoves.prototype.testCanCaptureDifferentColor = function () {
        // TODO:
    ...
    __decorate([
        alsatian_1.Setup
    ], TestQueenMoves.prototype, "beforeEach");
    __decorate([
        alsatian_1.Test("A Queen can move diagonally")
    ], TestQueenMoves.prototype, "testCanMoveDiagonally");
    __decorate([
        alsatian_1.Test("A Queen can move horizontally")
    ], TestQueenMoves.prototype, "testCanMoveHorizontally");
    __decorate([
        alsatian_1.Test("A Queen can move vertically")
    ], TestQueenMoves.prototype, "testCanMoveVertically");
    __decorate([
        alsatian_1.Test("A Queen can only move horizontally, vertically, and diagonally")
    ], TestQueenMoves.prototype, "testForbiddenMoves");
    __decorate([
        alsatian_1.Test("A Queen cannot leap other pieces")
    ], TestQueenMoves.prototype, "testCannotLeap");
    __decorate([
        alsatian_1.Test("A Queen cannot capure pieces from the same color")
    ], TestQueenMoves.prototype, "testCannotCaptureSameColor");
    __decorate([
        alsatian_1.Test("A Queen can capure pieces from a different color")
    ], TestQueenMoves.prototype, "testCanCaptureDifferentColor");
    return TestQueenMoves;
}());
exports.TestQueenMoves = TestQueenMoves;
